...
const SliderInfo = ({slider,logo}) => {
    ...
    return ( 
        <div className="slider-info font-primary gap-6 md:gap-0 grid grid-cols-1 md:grid-cols-2 absolute inset-0 max-w-screen-xl mx-auto px-5 justify-between mx-auto place-content-end md:place-content-center align-middle text-white">
